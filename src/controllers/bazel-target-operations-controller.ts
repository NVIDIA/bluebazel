...
//         let oldTarget: BazelTarget | undefined;
//         // If the targetOrAction is passed in here we will
//         // only show quick pick targets with that action,
//         // so reduce the action list to just that action.
//         // Otherwise, we show all actions avaiable.
//         // Additionally, cache the old target for replacing
//         // in the variable oldTarget.
//         if (targetOrAction instanceof BazelTarget) {
//             oldTarget = targetOrAction as BazelTarget;
//             actions.push(oldTarget.action);
//         } else if (typeof targetOrAction === 'string') {
//             actions.push(targetOrAction as BazelAction);
//         } else {
//             actions.push(...await this.bazelActionManager.getActions());
//         }
